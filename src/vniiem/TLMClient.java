...
import vniiem.utils.Crc;
import vniiem.utils.TimeManipulation;
...
public class TLMClient extends JFrame {
	...
	private void fillTLM() {
		...
		if (rand.nextInt(10) == 0) {
			...
			bb.putShort(Crc.crc16Ccitt(bb, 0, bb.position()));
		}
	...
	private void sendTLM() {
		byte[] buff = new byte[TLM_OBJECT_SIZE];
		synchronized (syncObject) {
